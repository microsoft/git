...
--no-prefetch::
	...
	initial worktree becomes ready as quickly as possible. The tip commit
	and the trees needed for the initial checkout are still downloaded
	through the `/gvfs/objects` endpoint.
+
